...
const loadPayPalScript = (cartSubtotal, cartItems, orderId, updateStateAfterOrder) => {
    loadScript({
        "client-id":
            "AaeeimiWX9ymoJBaQ1QHBvBsuAjFa5taiOeEP1qS6axIly5fhFirW819V9dQYXvsOsTtuJdT2v-TTmDo"
    })
        .then(paypal => {
            paypal.Buttons(buttons(cartSubtotal, cartItems, orderId, updateStateAfterOrder))
