                        ...
                        <Form.Group controlId="formFileMultiple" className='mb-3 mt-3'>
                            ...
                            <Row>
                                ...
                                <Col key={idx} style={{ position: "relative" }} xs={3}>
                                    ...
                                    <i style={onHover} onClick={() => imageDeleteHandler(image.path, id).then(data => setImageRemoved(!imageRemoved))}
                            ...
                            <Form.Control required type="file" multiple onChange={e => {
                                ...
                                if (process.env.NODE_ENV !== "production") { //to do
                                    ...
                                    setIsUploading("upload file completed. Wait for the result take effect, refresh also if necessary");
                                    setTimeout(() => {
                                        setImageUploaded(!imageUploaded);
                                    }, 5000)
                                }
